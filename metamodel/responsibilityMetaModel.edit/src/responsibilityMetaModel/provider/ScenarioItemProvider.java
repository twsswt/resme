...
/**
 * This is the item provider adapter for a {@link responsibilityMetaModel.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ResponsibilityMetaModelPackage.Literals.SCENARIO__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ResponsibilityMetaModelPackage.Literals.SCENARIO__RESOURCES);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ResponsibilityMetaModelPackage.Literals.SCENARIO__RESOURCES,
				 ResponsibilityMetaModelFactory.eINSTANCE.createResource()));

		newChildDescriptors.add
			(createChildParameter
				(ResponsibilityMetaModelPackage.Literals.SCENARIO__RESPONSIBILITIES,
				 ResponsibilityMetaModelFactory.eINSTANCE.createResponsibility()));

		newChildDescriptors.add
			(createChildParameter
				(ResponsibilityMetaModelPackage.Literals.SCENARIO__ACTORS,
				 ResponsibilityMetaModelFactory.eINSTANCE.createActor()));
